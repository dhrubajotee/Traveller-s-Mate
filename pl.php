...
<style>
  ...
  body{
	background-image: url("images438394.jpg");
...
div.desc {
   ...
   text-align: center;
    ...
    border-radius: 190px;
    background-image: url('images/ancient_ways_32453168623.jpg');
     background-size: 100px 100px;
     font-weight: bold;
}
...
<div class="gallery">
 ...
 <div class="gallery">
  ...
  <div class="dtls"><p>Bangladesh is the most densely populated nonisland nation in the world. With approximately 125 million inhabitants living in an area of 55,813 square miles and 2,240 persons per square mile. 
...
<div class="gallery">
  ...
  <div class="dtls"><p>Parliamentary Democracy</p></div><div><img src="images/0324.jpg"></div>
</div>
<div class="gallery">
  <div class="desc">Geographic Coordinates
  </div>
  <div class="dtls"><p>23 43 N, 90 24 E</p></div><div><img src="images/bangladesh-location-map.jpg"></div>
</div>
<div class="gallery">
